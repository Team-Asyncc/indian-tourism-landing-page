...
const text = [ {title :"Thrissur" , para : "Often referred to as the cultural capital of Kerala, Thrissur is a centre poi..." }
               ,{title :"Goa" , para : "The pocket-sized paradise of Goa is a traveller's dream. Sun, sea, sand, spices,..."  }
               ,{title :"Gokarna" , para: "With stunning beaches, legendary temples and offering several adventure ..."}
               ,{title :"Kochi" , para: "A vibrant potpourri of art, culture, food, carnivals and festivals,  .."}
               ,{title :"Bekal" , para: "An emerald gem set amidst honey-hued beaches, pristine waterfalls and .."}
               ,{title :"Statue of unity" , para: "An emerald gem set amidst honey-hued beaches, pristine waterfalls.." }
               ,{title :"Munnar" ,para : "A lush carpet of rolling green, interrupted by low rises of mountains of.." }
               ,{title :"Shilong" ,para: "Colonial-era charm, a landscape of rolling green and pristine mountains ..."}
               ,{title :"Wayanad" ,para:"A coffer of coffee, cardamom and tea plantations, which envelope the land..."}
...
export default function MustVisit() {
  ...
  return (
    <>
     ...
     <h1 class='header'>Must Visit Destinations</h1>
    ...
    <div className="must-visit">
      ...
      {datas.map((_, idx) => {
        return (
          <div className="card" key={idx} style={{transform : `translateX( ${x}%)`  }} >
            <div id='image' style={{ backgroundImage:`url(${datas[idx].image})` } } > </div>
